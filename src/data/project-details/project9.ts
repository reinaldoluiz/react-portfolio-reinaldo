...
export const project9: Project = {
  id: 9,
  title: "Meu Portfólio Pessoal",
  subtitle: "Desenvolvimento de site com assistência de IA",
  description: "Este site foi criado utilizando uma plataforma de desenvolvimento assistida por IA. As ilustrações e o layout foram gerados com IA, e conhecimentos de desenvolvimento foram essenciais para customizar, resolver problemas e implementar funcionalidades específicas ao longo do projeto.",
  year: "2025",
