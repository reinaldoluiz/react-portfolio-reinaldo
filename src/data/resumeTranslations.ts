...
export const resumeTranslations = {
  ...
  es: {
    ...
    skills: {
      ...
      categories: [
        ...
        {
          title: "Investigación UX y Estrategia",
          skills: [
  ...
  ca: {
    ...
    skills: {
      title: "Competències Principals",
      categories: [
        {
          title: "Disseny i Prototipatge",
          skills: [
            "Figma & Adobe Creative Suite",
            "Design Systems & Style guides",
        ...
        {
          title: "Recerca UX i Estratègia",
          skills: [
            "Recerca d'usuaris & persones",
            "Proves d'usabilitat",
            "Journey mapping",
            "Anàlisi de dades & mètriques",
            "Proves A/B"
          ]
        },
        {
    ...
    languages: {
      title: "Idiomes",
      items: [
        { language: "Portuguès", level: "Natiu" },
        { language: "Anglès", level: "Avançat" },
        { language: "Espanyol", level: "Intermedi" }
      ]
    },
    printButton: "Imprimir CV"
  }
